      ...
      .then((res) => {
        if (res.twoFAKey !== '') {
          const fullUrl =
            ...
            400 +
            '&chl=' +
            encodeURIComponent(this.state.twofaKey);
    ...
    APIService.getSettings(this.props.user.token)
      ...
      .then((res) => {
        this.setState({
          fullname: res.name,
          email: res.email,
          timezone: timezone.time_zones,
          selectedTimezone: res.time_zone,
        ...
        <Tabs
          ...
          <Tab
            ...
            <View style={styles.profileContainer}>
              ...
              <Text style={styles.fullnameText}>E-mail</Text>
              <Item regular style={styles.fullnameInput}>
                <Input
                  onChangeText={(email) => {
              ...
              <Text style={styles.fullnameText}>Time Zone</Text>
              <DropDownPicker
                ...
                <View style={styles.selectAvatarForm}>
                  ...
                  <TouchableOpacity onPress={this.selectAvatar}>
                    <View style={styles.selectAvatarButton}>
                      <Text style={styles.avatarSelectText}>Select Image</Text>
                    </View>
                  </TouchableOpacity>
                  <TouchableOpacity
                    style={styles.removeAvatarButton}
                    onPress={this.removeAvatar}>
                    <Text style={styles.removeAvatarStyle}>Remove Image</Text>
                  </TouchableOpacity>
                </View>
              </View>
              <Button
          ...
          <Tab
            ...
            <View style={styles.profileContainer}>
              <Text style={styles.fullnameText}>Current Password</Text>
              <Item regular style={styles.fullnameInput}>
                <Input
              ...
              <Text style={styles.fullnameText}>New Password</Text>
              <Item regular style={styles.fullnameInput}>
                <Input
                  secureTextEntry={true}
              ...
              <Text style={styles.fullnameText}>Confirm Password</Text>
              <Item regular style={styles.fullnameInput}>
                <Input
                  secureTextEntry={true}
          ...
          <Tab
            ...
            activeTabStyle={styles.activeTabStyle}
            activeTextStyle={styles.activeTabTextStyle}>
            <ScrollView style={styles.twoFactorTabScrollContainer}>
              <Text style={styles.profileText}>Two Factor Authentication</Text>
              <Text style={styles.followStepText}>
              ...
              <View>
                ...
                <View style={styles.firstStepBodyLayout}>
                  <Text style={styles.installAuthAppDescription}>
                    Get the Google Authenticator app from App Store for iOS or
                ...
                <View style={styles.stepBodyLayout}>
                  <View style={styles.qrCodeLayout}>
                    ...
                    />
                    <Text style={styles.manualEntryKeyText}>
                      Use manual entry key
                    </Text>
                    <Text style={styles.twofaKeyText}>
                      {this.state.twofaKey}
                    </Text>
                    <TouchableOpacity>
              ...
              <View style={styles.otpCodeInputLayout}>
                <TextInput
                ...
                <TextInput
                  ...
                  onKeyPress={({nativeEvent}) =>
                    this.backNavigationInput(nativeEvent, 2)
                  }
                ...
                <TextInput
                  ...
                  onKeyPress={({nativeEvent}) =>
                    this.backNavigationInput(nativeEvent, 3)
                  }
                  onFocus={() => this.searchCurrentInput()}
                ...
                <TextInput
                  ...
                  onKeyPress={({nativeEvent}) =>
                    this.backNavigationInput(nativeEvent, 4)
                  }
                  onFocus={() => this.searchCurrentInput()}
                ...
                <TextInput
                  ...
                  onKeyPress={({nativeEvent}) =>
                    this.backNavigationInput(nativeEvent, 5)
                  }
                  onFocus={() => this.searchCurrentInput()}
                ...
                <TextInput
                  ...
                  onKeyPress={({nativeEvent}) =>
                    this.backNavigationInput(nativeEvent, 6)
                  }
                  onFocus={() => this.searchCurrentInput()}
              ...
              <View style={styles.twofaLoginButtonLayout}>
                {this.state.disableTwofa && (
                  <TouchableOpacity onPress={this.disableTwofa}>
                    <Text style={styles.disableTwofaText}>Disabe</Text>
                  </TouchableOpacity>
                )}
                {!this.state.disableTwofa && (
                  <TouchableOpacity>
                    <Text style={styles.disableTwofaText} />
                  </TouchableOpacity>
                )}
                <TouchableOpacity onPress={this.setupTwofaKey}>
                  <Text style={styles.twofaLoginButtonText}>Log In</Text>
                </TouchableOpacity>
              </View>
            </ScrollView>
          </Tab>
...
const styles = StyleSheet.create({
  ...
  twofaLoginButtonLayout: {
    flexDirection: 'row',
    justifyContent: 'space-between',
  },
  twofaLoginButtonText: {
    backgroundColor: '#0088ff',
    color: 'white',
    paddingHorizontal: 20,
    paddingVertical: 10,

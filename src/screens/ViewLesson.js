    ...
    return (
      <Container style={styles.container}>
        {!this.props.library.fullscreen && (
          <Header noShadow style={styles.navBarHeader}>
            <Left>
              <TouchableOpacity
                onPress={() => {
        ...
        {!this.props.library.fullscreen && (
          <Header noShadow style={styles.headerLayout}>
            <Body style={styles.navbarHeaderBodyTitle}>
